...
This is a Restaurant Management System built using PHP, designed to help restaurant owners manage operations such as orders, menu and staff. It features a responsive and user-friendly dashboard for admins and staff.
...
backend/html/ – reusable components (e.g., header, footer)

assets/ – images

backend/db/ – .sql, db, functions
